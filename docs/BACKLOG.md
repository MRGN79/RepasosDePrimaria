...
| **Contenido de 2.º de Primaria (MVP ligero)** — catálogo multi-curso con contenido (refactor de infraestructura: registry/catalog conscientes de curso, aislamiento 2.º↔3.º) + primer paquete jugable de 2.º en las 5 materias troncales, alineado a LOMLOE (RD 157/2022) | `feat/contenido-2do-primaria-mvp` | 🔨 En curso. Extiende ADR-002 (adenda multi-curso con contenido). No confundir con el pivote Firebase (paralelo). Contenido original propio (mismo estándar legal que 3.º) |
