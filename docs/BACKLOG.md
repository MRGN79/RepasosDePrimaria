...
| **Contenido de 2.º de Primaria (MVP ligero)** — catálogo multi-curso con contenido (refactor de infraestructura: registry/catalog conscientes de curso, aislamiento 2.º↔3.º) + primer paquete jugable de 2.º en las 5 materias troncales, alineado a LOMLOE (RD 157/2022) | `feat/contenido-2do-primaria-mvp` | ✅ Completo, pendiente de **PR del usuario** (no abierta a propósito). 2 commits en la rama; tests 1898 ✔, lint ✔, build ✔. Adenda a ADR-002 + spec `08-catalogo-materias-temas-2do.md`. Contenido: mates (4 temas: numeración a 100 + suma/resta sin llevar + tablas 2/5/10 generadas), lengua (sílabas, mayúsculas, singular/plural), Natural Science (sentidos, cuerpo, animales), sociales (familia, colegio, barrio), English (números 1-20, colores, mascotas) — ~13 temas, 130 ítems estáticos + 3 generadores. **Decisión de versión pendiente del usuario** (fold en 0.6.0 del pivote vs. 0.7.0 propia): manifiesto sin bumpear a la espera. Contenido original propio, mismo estándar legal que 3.º |
