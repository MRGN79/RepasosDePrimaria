...
| R10 | Tercero (Google reCAPTCHA v3) recibe señales del dispositivo con fines antiabuso (App Check, ADR-005), posiblemente del dispositivo de un menor (Modelo B) | Baja | Bajo | Bajo | Uso estrictamente de seguridad, no analítico ni publicitario; Google como encargado; modo monitor (no bloquea, no condiciona el uso de la app); proveedor interino hasta que Play Integrity —atestación de dispositivo sin scoring conductual en página— sea viable |
