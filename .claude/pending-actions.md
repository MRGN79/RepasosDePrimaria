...
- [ ] 2026-08-03 13:35 | otro | **Bloqueo externo para la implementación de ADR-003**: crear el proyecto Firebase real (Firebase Console, habilitar Auth + Firestore en región europea, obtener credenciales/`google-services.json`) requiere una acción manual del usuario — no hay acceso a Firebase/Google Cloud desde este entorno. Se puede avanzar código y configuración asumiendo esas credenciales, pero la integración real no se podrá probar de extremo a extremo hasta recibirlas.
